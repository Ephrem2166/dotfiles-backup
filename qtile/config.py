...
widget_defaults = dict(
    ...
    fontsize=10,
    padding=0,
    foreground=everforest["foreground"],
)
        ...
        top=bar.Bar(
            [
                ...
                widget.GroupBox(
                    ...
                    active=everforest["foreground"],
                    inactive=everforest["white-alt"],
                    highlight_color=everforest["black-alt"],
                    this_current_screen_border=everforest["green"],
                    this_screen_border=everforest["black"],
                    other_screen_border=everforest["red"],
                    other_current_screen_border=everforest["red"],
                    background=everforest["background"],
                    foreground=everforest["foreground"],
                    **arrow_powerlineLeft,
                ),
                widget.TaskList(
                    ...
                    foreground=everforest["foreground"],
                    background=everforest["background"],
                    border=everforest["background"],
                    urgent_border=everforest["red-alt"],
                    txt_floating=" ",
                    txt_maximized=" ",
                    txt_minimized=" ",
                ),
                ...
                widget.CPU(
                    ...
                    foreground=everforest["white"],
                    background=everforest["black"],
                    **slash_powerlineRight,
                ),
                widget.ThermalSensor(
                    ...
                    #tag_sensor="Tctl",
                    foreground=everforest["white"],
                    background=everforest["blue-alt"],
                    **slash_powerlineRight,
                ),
                widget.Memory(
                    padding=5,
                    format="󰈀 {MemUsed:.0f}{mm}",
                    background=everforest["black-alt"],
